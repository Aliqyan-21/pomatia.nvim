...
function M.get(c, opts)
  return {
    ...
    ["@string.escape"]               = { fg = c.fg_muted, bg = opts.variant == "noir" and c.bg_alt or nil },
    ["@string.special"]              = { fg = c.fg_muted, bg = opts.variant == "noir" and c.bg_alt or nil },
    ["@string.special.symbol"]       = { fg = c.blue, bg = opts.variant == "noir" and c.bg_alt or nil },
    ["@string.special.url"]          = { fg = c.blue, bg = opts.variant == "noir" and c.bg_alt or nil },
    ["@string.regexp"]               = { fg = c.fg_muted, bg = opts.variant == "noir" and c.bg_alt or nil },
    ...
    ["@markup.link.url"]             = { fg = c.blue, underline = true, bg = opts.variant == "noir" and c.bg_alt or nil },
